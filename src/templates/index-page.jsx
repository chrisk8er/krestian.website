...
export const IndexPageTemplate = ({
  ...
  <section className="section has-background-grey-dark">
    {/* <h1 className="is-size-1 has-text-light">Krestian Weken</h1> */}
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 351.91 76.28">
      <defs>
      ...
      <g style={{clipPath: "url(#clip-path)"}}>
        <path className="path" d="M34,14S11,55,18,72" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "20px"}}/>
      </g>
      <g style={{clipPath: "url(#clip-path-2)"}}>
        <path className="path" d="M51,3s4,10-8,26" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "16px"}}/>
      </g>
      <g style={{clipPath: "url(#clip-path-3)"}}>
        <path className="path" d="M61,33S46,59,49,66c0,0,22-30,28-32,6.64-2.21-14.5,34.5-14.5,34.5S89,37,94,38s-8.5,14.5-8.5,22.5S97,65,97,65" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "9px"}}/>
      </g>
      <g style={{clipPath: "url(#clip-path-4)"}}>
        <path className="path" d="M143.5,7.5s-20.08,48.74-23,65" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "12px"}}/>
        <path className="path" d="M178.5,13.5s-26,5-38,31c-6,13,15,27,15,27" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "11px"}}/>
      </g>
      <g style={{clipPath: "url(#clip-path-5)"}}>
        <path className="path" d="M189.5,52.5c-8-5,7-23-9-12-7.66,5.27-17,29.68-17.5,27.5-2.5-10.5,15.5-38.5,15.5-38.5" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "9px"}}/>
      </g>
      <g style={{clipPath: "url(#clip-path-6)"}}>
        <path className="path" d="M217.5,57.5s-15,14-19.16,10.46-4.16-3.51-1.84-17.46c2-12,20-18,20.43-15.68C218.81,45,200.5,59.5,200.5,59.5" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "9px"}}/>
      </g>
      <g style={{clipPath: "url(#clip-path-7)"}}>
        <path className="path" d="M245.5,46.5c.05-.11,1.09-14.73-8-12C227.5,37.5,233,55,233,55s3,12-4,15-12,2-12-1,7.5-18.5,22.5-14.5" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "9px"}}/>
      </g>
      <g style={{clipPath: "url(#clip-path-8)"}}>
        <path className="path" d="M269,22s-15.5,22.5-17,35c-1.55,12.91,5,11,6,11s7.7-3.94,7.7-3.94" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "9px"}}/>
        <line className="path" x1="242.83" y1="37.47" x2="265.83" y2="35.47" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "9px"}}/>
      </g>
      <g style={{clipPath: "url(#clip-path-9)"}}>
        <path className="path" d="M286.5,35.5a47.2,47.2,0,0,0-13,33" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "9px"}}/>
        <line className="path" x1="285.83" y1="16.47" x2="278.83" y2="32.47" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "10px"}}/>
      </g>
      <g style={{clippPth: "url(#clip-path-10)"}}>
        <path className="path" d="M308,35s-22.21,13.74-17,31c4.16,13.78,23.79-33.22,24.5-32.5,0,0-9,31-4.5,36.5" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "9px"}}/>
      </g>
      <g style={{clippPth: "url(#clip-path-11)"}}>
        <path className="path" d="M338,32s-15.58,23.19-14,33c2,12.49,15.77-29,28-28,6.73.55-19,36,5,28" transform="translate(-6.67 -0.03)" style={{fill: "none", stroke: "#fff", strokeMiterlimit: 10, strokeWidth: "10px"}}/>
      </g>
    </svg>

 <TypedElement className="has-text-grey-light" messages={messages} />
  </section>
);
